...
in.ReserveUp=ReserveUp;      %% up reserve
in.ReserveDn=ReserveDn;      %% dowen reserve
%%-------------- results
...
for roll=1:RollNum
    ...
    in.ReserveUp=ReserveUp(RollStart(roll):RollStart(roll+1)-1,:);      %% up reserve
    in.ReserveDn=ReserveDn(RollStart(roll):RollStart(roll+1)-1,:);      %% dowen reserve
    %%solution
